 ...
 */
final class OpenApiAnnotationToAttributeMapper implements AnnotationToAttributeMapperInterface
{
    /**
    ...
    private function resolveAnnotationName(OpenApiTagValueNode $openApiTagValueNode) : string
    {
        $annotationShortName = $openApiTagValueNode->getDoctrineAnnotationTagValueNode()->identifierTypeNode->name;
